...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 3f 77 10 80 	movl   $0x8010773f,(%esp)
...
80102e83:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e86:	e8 a5 39 00 00       	call   80106830 <switchkvm>
  seginit();
80102e8b:	e8 10 39 00 00       	call   801067a0 <seginit>
  lapicinit();
...
80102ec1:	e8 3a 3e 00 00       	call   80106d00 <kvmalloc>
  mpinit();        // detect other processors
80102ec6:	e8 75 01 00 00       	call   80103040 <mpinit>
  lapicinit();     // interrupt controller
80102ecb:	e8 60 f7 ff ff       	call   80102630 <lapicinit>
  seginit();       // segment descriptors
80102ed0:	e8 cb 38 00 00       	call   801067a0 <seginit>
  picinit();       // disable pic
...
80102ee4:	e8 87 2b 00 00       	call   80105a70 <uartinit>
  pinit();         // process table
...
80103823:	e8 58 34 00 00       	call   80106c80 <setupkvm>
...
80103841:	e8 1a 31 00 00       	call   80106960 <inituvm>
...
8010392c:	e8 1f 2f 00 00       	call   80106850 <switchuvm>
  return 0;
...
8010394a:	e8 51 31 00 00       	call   80106aa0 <allocuvm>
...
8010396a:	e8 61 32 00 00       	call   80106bd0 <deallocuvm>
...
801039b8:	e8 93 33 00 00       	call   80106d50 <copyuvm>
...
80103af0:	e8 5b 2d 00 00       	call   80106850 <switchuvm>
...
80103b02:	e8 84 0b 00 00       	call   8010468b <swtch>
      switchkvm();
80103b07:	e8 24 2d 00 00       	call   80106830 <switchkvm>
      c->proc = 0;
...
80103ed2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ed9:	e8 22 2d 00 00       	call   80106c00 <freevm>
        release(&ptable.lock);
...
8010402b:	68 3f 77 10 80       	push   $0x8010773f
...
80104a05:	68 cf 76 10 80       	push   $0x801076cf
...
80104a1a:	68 de 76 10 80       	push   $0x801076de
80104a1f:	e8 6c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a24:	83 ec 0c             	sub    $0xc,%esp
80104a27:	68 c0 76 10 80       	push   $0x801076c0
...
80104e19:	58                   	pop    %eax
80104e1a:	5a                   	pop    %edx
80104e1b:	68 dc 76 10 80       	push   $0x801076dc
...
80104e34:	68 db 76 10 80       	push   $0x801076db
...
8010563b:	8b 40 14             	mov    0x14(%eax),%eax
...
801056be:	00 00 ef 
  initlock(&tickslock, "time");
801056c1:	68 21 77 10 80       	push   $0x80107721
801056c6:	68 60 4c 11 80       	push   $0x80114c60
  SETGATE(idt[T_PROJECT01_2], 1, SEG_KCODE<<3, vectors[T_PROJECT01_2], DPL_USER);
801056cb:	c7 05 a2 50 11 80 08 	movl   $0xef000008,0x801150a2
801056d2:	00 00 ef 
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056d5:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
801056db:	c1 e8 10             	shr    $0x10,%eax
801056de:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  SETGATE(idt[T_PROJECT01_2], 1, SEG_KCODE<<3, vectors[T_PROJECT01_2], DPL_USER);
801056e4:	a1 08 a2 10 80       	mov    0x8010a208,%eax
801056e9:	66 a3 a0 50 11 80    	mov    %ax,0x801150a0
801056ef:	c1 e8 10             	shr    $0x10,%eax
801056f2:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
801056f8:	e8 03 eb ff ff       	call   80104200 <initlock>
}
...
80105752:	0f 84 f8 00 00 00    	je     80105850 <trap+0x110>
      exit();
    return;
  }
...
80105758:	3d 80 00 00 00       	cmp    $0x80,%eax
8010575d:	0f 84 f5 01 00 00    	je     80105958 <trap+0x218>
	  cprintf("user interrupt %d called!\n", T_PROJECT01_2);
	  exit();
  }

  switch(tf->trapno){
80105763:	83 e8 20             	sub    $0x20,%eax
80105766:	83 f8 1f             	cmp    $0x1f,%eax
80105769:	77 0d                	ja     80105778 <trap+0x38>
8010576b:	ff 24 85 e4 77 10 80 	jmp    *-0x7fef881c(,%eax,4)
...
80105778:	e8 63 e0 ff ff       	call   801037e0 <myproc>
8010577d:	85 c0                	test   %eax,%eax
8010577f:	8b 5f 38             	mov    0x38(%edi),%ebx
80105782:	0f 84 3c 02 00 00    	je     801059c4 <trap+0x284>
80105788:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
8010578c:	0f 84 32 02 00 00    	je     801059c4 <trap+0x284>
...
80105792:	0f 20 d1             	mov    %cr2,%ecx
80105795:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
80105798:	e8 23 e0 ff ff       	call   801037c0 <cpuid>
8010579d:	89 45 dc             	mov    %eax,-0x24(%ebp)
801057a0:	8b 47 34             	mov    0x34(%edi),%eax
801057a3:	8b 77 30             	mov    0x30(%edi),%esi
...
801057b1:	e8 2a e0 ff ff       	call   801037e0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801057b6:	8b 4d d8             	mov    -0x28(%ebp),%ecx
801057b9:	8b 55 dc             	mov    -0x24(%ebp),%edx
801057bc:	51                   	push   %ecx
801057bd:	53                   	push   %ebx
801057be:	52                   	push   %edx
            myproc()->pid, myproc()->name, tf->trapno,
801057bf:	8b 55 e0             	mov    -0x20(%ebp),%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801057c2:	ff 75 e4             	pushl  -0x1c(%ebp)
801057c5:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
801057c6:	83 c2 6c             	add    $0x6c,%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801057c9:	52                   	push   %edx
801057ca:	ff 70 10             	pushl  0x10(%eax)
801057cd:	68 a0 77 10 80       	push   $0x801077a0
801057d2:	e8 89 ae ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801057d7:	83 c4 20             	add    $0x20,%esp
...
801057e6:	e8 f5 df ff ff       	call   801037e0 <myproc>
801057eb:	85 c0                	test   %eax,%eax
801057ed:	74 1d                	je     8010580c <trap+0xcc>
801057ef:	e8 ec df ff ff       	call   801037e0 <myproc>
801057f4:	8b 50 24             	mov    0x24(%eax),%edx
801057f7:	85 d2                	test   %edx,%edx
801057f9:	74 11                	je     8010580c <trap+0xcc>
801057fb:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
801057ff:	83 e0 03             	and    $0x3,%eax
80105802:	66 83 f8 03          	cmp    $0x3,%ax
80105806:	0f 84 74 01 00 00    	je     80105980 <trap+0x240>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
8010580c:	e8 cf df ff ff       	call   801037e0 <myproc>
80105811:	85 c0                	test   %eax,%eax
80105813:	74 0b                	je     80105820 <trap+0xe0>
80105815:	e8 c6 df ff ff       	call   801037e0 <myproc>
8010581a:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
8010581e:	74 68                	je     80105888 <trap+0x148>
...
80105827:	74 19                	je     80105842 <trap+0x102>
80105829:	e8 b2 df ff ff       	call   801037e0 <myproc>
8010582e:	8b 40 24             	mov    0x24(%eax),%eax
80105831:	85 c0                	test   %eax,%eax
80105833:	74 0d                	je     80105842 <trap+0x102>
80105835:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105839:	83 e0 03             	and    $0x3,%eax
8010583c:	66 83 f8 03          	cmp    $0x3,%ax
80105840:	74 37                	je     80105879 <trap+0x139>
    exit();
}
80105842:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105845:	5b                   	pop    %ebx
80105846:	5e                   	pop    %esi
80105847:	5f                   	pop    %edi
80105848:	5d                   	pop    %ebp
...
80105855:	8b 58 24             	mov    0x24(%eax),%ebx
80105858:	85 db                	test   %ebx,%ebx
8010585a:	0f 85 e8 00 00 00    	jne    80105948 <trap+0x208>
    myproc()->tf = tf;
80105860:	e8 7b df ff ff       	call   801037e0 <myproc>
80105865:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105868:	e8 d3 ef ff ff       	call   80104840 <syscall>
    if(myproc()->killed)
8010586d:	e8 6e df ff ff       	call   801037e0 <myproc>
80105872:	8b 48 24             	mov    0x24(%eax),%ecx
80105875:	85 c9                	test   %ecx,%ecx
80105877:	74 c9                	je     80105842 <trap+0x102>
}
...
8010587f:	5d                   	pop    %ebp
      exit();
80105880:	e9 7b e3 ff ff       	jmp    80103c00 <exit>
80105885:	8d 76 00             	lea    0x0(%esi),%esi
  if(myproc() && myproc()->state == RUNNING &&
80105888:	83 7f 30 20          	cmpl   $0x20,0x30(%edi)
8010588c:	75 92                	jne    80105820 <trap+0xe0>
    yield();
8010588e:	e8 9d e4 ff ff       	call   80103d30 <yield>
80105893:	eb 8b                	jmp    80105820 <trap+0xe0>
80105895:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105898:	e8 23 df ff ff       	call   801037c0 <cpuid>
8010589d:	85 c0                	test   %eax,%eax
8010589f:	0f 84 eb 00 00 00    	je     80105990 <trap+0x250>
    lapiceoi();
801058a5:	e8 a6 ce ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058aa:	e8 31 df ff ff       	call   801037e0 <myproc>
801058af:	85 c0                	test   %eax,%eax
801058b1:	0f 85 38 ff ff ff    	jne    801057ef <trap+0xaf>
801058b7:	e9 50 ff ff ff       	jmp    8010580c <trap+0xcc>
801058bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801058c0:	e8 4b cd ff ff       	call   80102610 <kbdintr>
    lapiceoi();
801058c5:	e8 86 ce ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058ca:	e8 11 df ff ff       	call   801037e0 <myproc>
801058cf:	85 c0                	test   %eax,%eax
801058d1:	0f 85 18 ff ff ff    	jne    801057ef <trap+0xaf>
801058d7:	e9 30 ff ff ff       	jmp    8010580c <trap+0xcc>
801058dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
801058e0:	e8 7b 02 00 00       	call   80105b60 <uartintr>
    lapiceoi();
801058e5:	e8 66 ce ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058ea:	e8 f1 de ff ff       	call   801037e0 <myproc>
801058ef:	85 c0                	test   %eax,%eax
801058f1:	0f 85 f8 fe ff ff    	jne    801057ef <trap+0xaf>
801058f7:	e9 10 ff ff ff       	jmp    8010580c <trap+0xcc>
...
8010590f:	68 48 77 10 80       	push   $0x80107748
...
80105928:	0f 85 c1 fe ff ff    	jne    801057ef <trap+0xaf>
8010592e:	e9 d9 fe ff ff       	jmp    8010580c <trap+0xcc>
80105933:	90                   	nop
80105934:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105938:	e8 43 c7 ff ff       	call   80102080 <ideintr>
8010593d:	e9 63 ff ff ff       	jmp    801058a5 <trap+0x165>
80105942:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105948:	e8 b3 e2 ff ff       	call   80103c00 <exit>
8010594d:	e9 0e ff ff ff       	jmp    80105860 <trap+0x120>
80105952:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	  cprintf("user interrupt %d called!\n", T_PROJECT01_2);
80105958:	83 ec 08             	sub    $0x8,%esp
8010595b:	68 80 00 00 00       	push   $0x80
80105960:	68 26 77 10 80       	push   $0x80107726
80105965:	e8 f6 ac ff ff       	call   80100660 <cprintf>
	  exit();
8010596a:	e8 91 e2 ff ff       	call   80103c00 <exit>
8010596f:	8b 47 30             	mov    0x30(%edi),%eax
80105972:	83 c4 10             	add    $0x10,%esp
80105975:	e9 e9 fd ff ff       	jmp    80105763 <trap+0x23>
8010597a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105980:	e8 7b e2 ff ff       	call   80103c00 <exit>
80105985:	e9 82 fe ff ff       	jmp    8010580c <trap+0xcc>
...
801059a4:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
801059ab:	e8 80 e5 ff ff       	call   80103f30 <wakeup>
      release(&tickslock);
...
801059bf:	e9 e1 fe ff ff       	jmp    801058a5 <trap+0x165>
801059c4:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801059c7:	e8 f4 dd ff ff       	call   801037c0 <cpuid>
...
801059d5:	68 6c 77 10 80       	push   $0x8010776c
801059da:	e8 81 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
801059df:	83 c4 14             	add    $0x14,%esp
801059e2:	68 41 77 10 80       	push   $0x80107741
...
80105a45:	e8 26 cd ff ff       	call   80102770 <microdelay>
...
80105ae8:	e8 e3 c7 ff ff       	call   801022d0 <ioapicenable>
...
80105b77:	6a 00                	push   $0x0
  jmp alltraps
80105b79:	e9 c5 fa ff ff       	jmp    80105643 <alltraps>
...
80105b80:	6a 01                	push   $0x1
  jmp alltraps
80105b82:	e9 bc fa ff ff       	jmp    80105643 <alltraps>
...
80105b89:	6a 02                	push   $0x2
  jmp alltraps
80105b8b:	e9 b3 fa ff ff       	jmp    80105643 <alltraps>
...
80105bbd:	6a 08                	push   $0x8
  jmp alltraps
80105bbf:	e9 7f fa ff ff       	jmp    80105643 <alltraps>
...
80105bc6:	6a 09                	push   $0x9
  jmp alltraps
80105bc8:	e9 76 fa ff ff       	jmp    80105643 <alltraps>
...
80105bd4:	6a 0b                	push   $0xb
  jmp alltraps
80105bd6:	e9 68 fa ff ff       	jmp    80105643 <alltraps>
...
80105bdb:	6a 0c                	push   $0xc
  jmp alltraps
80105bdd:	e9 61 fa ff ff       	jmp    80105643 <alltraps>
...
80105be2:	6a 0d                	push   $0xd
  jmp alltraps
80105be4:	e9 5a fa ff ff       	jmp    80105643 <alltraps>
...
80105be9:	6a 0e                	push   $0xe
  jmp alltraps
80105beb:	e9 53 fa ff ff       	jmp    80105643 <alltraps>
...
80105bf2:	6a 0f                	push   $0xf
  jmp alltraps
80105bf4:	e9 4a fa ff ff       	jmp    80105643 <alltraps>
...
80105bfb:	6a 10                	push   $0x10
  jmp alltraps
80105bfd:	e9 41 fa ff ff       	jmp    80105643 <alltraps>
...
80105c02:	6a 11                	push   $0x11
  jmp alltraps
80105c04:	e9 3a fa ff ff       	jmp    80105643 <alltraps>
...
80105c0b:	6a 12                	push   $0x12
  jmp alltraps
80105c0d:	e9 31 fa ff ff       	jmp    80105643 <alltraps>
...
80105c14:	6a 13                	push   $0x13
  jmp alltraps
80105c16:	e9 28 fa ff ff       	jmp    80105643 <alltraps>
...
80105c1d:	6a 14                	push   $0x14
  jmp alltraps
80105c1f:	e9 1f fa ff ff       	jmp    80105643 <alltraps>
...
80105c26:	6a 15                	push   $0x15
  jmp alltraps
80105c28:	e9 16 fa ff ff       	jmp    80105643 <alltraps>
...
80105c2f:	6a 16                	push   $0x16
  jmp alltraps
80105c31:	e9 0d fa ff ff       	jmp    80105643 <alltraps>
...
80105c38:	6a 17                	push   $0x17
  jmp alltraps
80105c3a:	e9 04 fa ff ff       	jmp    80105643 <alltraps>
...
80105c41:	6a 18                	push   $0x18
  jmp alltraps
80105c43:	e9 fb f9 ff ff       	jmp    80105643 <alltraps>
...
80105c4a:	6a 19                	push   $0x19
  jmp alltraps
80105c4c:	e9 f2 f9 ff ff       	jmp    80105643 <alltraps>
...
80105c53:	6a 1a                	push   $0x1a
  jmp alltraps
80105c55:	e9 e9 f9 ff ff       	jmp    80105643 <alltraps>
...
80105c5c:	6a 1b                	push   $0x1b
  jmp alltraps
80105c5e:	e9 e0 f9 ff ff       	jmp    80105643 <alltraps>
...
80105c65:	6a 1c                	push   $0x1c
  jmp alltraps
80105c67:	e9 d7 f9 ff ff       	jmp    80105643 <alltraps>
...
80105c6e:	6a 1d                	push   $0x1d
  jmp alltraps
80105c70:	e9 ce f9 ff ff       	jmp    80105643 <alltraps>
...
80105c77:	6a 1e                	push   $0x1e
  jmp alltraps
80105c79:	e9 c5 f9 ff ff       	jmp    80105643 <alltraps>
...
80105c80:	6a 1f                	push   $0x1f
  jmp alltraps
80105c82:	e9 bc f9 ff ff       	jmp    80105643 <alltraps>
...
80105c89:	6a 20                	push   $0x20
  jmp alltraps
80105c8b:	e9 b3 f9 ff ff       	jmp    80105643 <alltraps>
...
80105c92:	6a 21                	push   $0x21
  jmp alltraps
80105c94:	e9 aa f9 ff ff       	jmp    80105643 <alltraps>
...
80105c9b:	6a 22                	push   $0x22
  jmp alltraps
80105c9d:	e9 a1 f9 ff ff       	jmp    80105643 <alltraps>
...
80105ca4:	6a 23                	push   $0x23
  jmp alltraps
80105ca6:	e9 98 f9 ff ff       	jmp    80105643 <alltraps>
...
80105cad:	6a 24                	push   $0x24
  jmp alltraps
80105caf:	e9 8f f9 ff ff       	jmp    80105643 <alltraps>
...
80105cb6:	6a 25                	push   $0x25
  jmp alltraps
80105cb8:	e9 86 f9 ff ff       	jmp    80105643 <alltraps>
...
80105cbf:	6a 26                	push   $0x26
  jmp alltraps
80105cc1:	e9 7d f9 ff ff       	jmp    80105643 <alltraps>
...
80105cc8:	6a 27                	push   $0x27
  jmp alltraps
80105cca:	e9 74 f9 ff ff       	jmp    80105643 <alltraps>
...
80105cd1:	6a 28                	push   $0x28
  jmp alltraps
80105cd3:	e9 6b f9 ff ff       	jmp    80105643 <alltraps>
...
80105cda:	6a 29                	push   $0x29
  jmp alltraps
80105cdc:	e9 62 f9 ff ff       	jmp    80105643 <alltraps>
...
80105ce3:	6a 2a                	push   $0x2a
  jmp alltraps
80105ce5:	e9 59 f9 ff ff       	jmp    80105643 <alltraps>
...
80105cec:	6a 2b                	push   $0x2b
  jmp alltraps
80105cee:	e9 50 f9 ff ff       	jmp    80105643 <alltraps>
...
80105cf5:	6a 2c                	push   $0x2c
  jmp alltraps
80105cf7:	e9 47 f9 ff ff       	jmp    80105643 <alltraps>
...
80105cfe:	6a 2d                	push   $0x2d
  jmp alltraps
80105d00:	e9 3e f9 ff ff       	jmp    80105643 <alltraps>
...
80105d07:	6a 2e                	push   $0x2e
  jmp alltraps
80105d09:	e9 35 f9 ff ff       	jmp    80105643 <alltraps>
...
80105d10:	6a 2f                	push   $0x2f
  jmp alltraps
80105d12:	e9 2c f9 ff ff       	jmp    80105643 <alltraps>
...
80105d19:	6a 30                	push   $0x30
  jmp alltraps
80105d1b:	e9 23 f9 ff ff       	jmp    80105643 <alltraps>
...
80105d22:	6a 31                	push   $0x31
  jmp alltraps
80105d24:	e9 1a f9 ff ff       	jmp    80105643 <alltraps>
...
80105d2b:	6a 32                	push   $0x32
  jmp alltraps
80105d2d:	e9 11 f9 ff ff       	jmp    80105643 <alltraps>
...
80105d34:	6a 33                	push   $0x33
  jmp alltraps
80105d36:	e9 08 f9 ff ff       	jmp    80105643 <alltraps>
...
80105d3d:	6a 34                	push   $0x34
  jmp alltraps
80105d3f:	e9 ff f8 ff ff       	jmp    80105643 <alltraps>
...
80105d46:	6a 35                	push   $0x35
  jmp alltraps
80105d48:	e9 f6 f8 ff ff       	jmp    80105643 <alltraps>
...
80105d4f:	6a 36                	push   $0x36
  jmp alltraps
80105d51:	e9 ed f8 ff ff       	jmp    80105643 <alltraps>
...
80105d58:	6a 37                	push   $0x37
  jmp alltraps
80105d5a:	e9 e4 f8 ff ff       	jmp    80105643 <alltraps>
...
80105d61:	6a 38                	push   $0x38
  jmp alltraps
80105d63:	e9 db f8 ff ff       	jmp    80105643 <alltraps>
...
80105d6a:	6a 39                	push   $0x39
  jmp alltraps
80105d6c:	e9 d2 f8 ff ff       	jmp    80105643 <alltraps>
...
80105d73:	6a 3a                	push   $0x3a
  jmp alltraps
80105d75:	e9 c9 f8 ff ff       	jmp    80105643 <alltraps>
...
80105d7c:	6a 3b                	push   $0x3b
  jmp alltraps
80105d7e:	e9 c0 f8 ff ff       	jmp    80105643 <alltraps>
...
80105d85:	6a 3c                	push   $0x3c
  jmp alltraps
80105d87:	e9 b7 f8 ff ff       	jmp    80105643 <alltraps>
...
80105d8e:	6a 3d                	push   $0x3d
  jmp alltraps
80105d90:	e9 ae f8 ff ff       	jmp    80105643 <alltraps>
...
80105d97:	6a 3e                	push   $0x3e
  jmp alltraps
80105d99:	e9 a5 f8 ff ff       	jmp    80105643 <alltraps>
...
80105da0:	6a 3f                	push   $0x3f
  jmp alltraps
80105da2:	e9 9c f8 ff ff       	jmp    80105643 <alltraps>
...
80105da9:	6a 40                	push   $0x40
  jmp alltraps
80105dab:	e9 93 f8 ff ff       	jmp    80105643 <alltraps>
...
80105db2:	6a 41                	push   $0x41
  jmp alltraps
80105db4:	e9 8a f8 ff ff       	jmp    80105643 <alltraps>
...
80105dbb:	6a 42                	push   $0x42
  jmp alltraps
80105dbd:	e9 81 f8 ff ff       	jmp    80105643 <alltraps>
...
80105dc4:	6a 43                	push   $0x43
  jmp alltraps
80105dc6:	e9 78 f8 ff ff       	jmp    80105643 <alltraps>
...
80105dcd:	6a 44                	push   $0x44
  jmp alltraps
80105dcf:	e9 6f f8 ff ff       	jmp    80105643 <alltraps>
...
80105dd6:	6a 45                	push   $0x45
  jmp alltraps
80105dd8:	e9 66 f8 ff ff       	jmp    80105643 <alltraps>
...
80105ddf:	6a 46                	push   $0x46
  jmp alltraps
80105de1:	e9 5d f8 ff ff       	jmp    80105643 <alltraps>
...
80105de8:	6a 47                	push   $0x47
  jmp alltraps
80105dea:	e9 54 f8 ff ff       	jmp    80105643 <alltraps>
...
80105df1:	6a 48                	push   $0x48
  jmp alltraps
80105df3:	e9 4b f8 ff ff       	jmp    80105643 <alltraps>
...
80105dfa:	6a 49                	push   $0x49
  jmp alltraps
80105dfc:	e9 42 f8 ff ff       	jmp    80105643 <alltraps>
...
80105e03:	6a 4a                	push   $0x4a
  jmp alltraps
80105e05:	e9 39 f8 ff ff       	jmp    80105643 <alltraps>
...
80105e0c:	6a 4b                	push   $0x4b
  jmp alltraps
80105e0e:	e9 30 f8 ff ff       	jmp    80105643 <alltraps>
...
80105e15:	6a 4c                	push   $0x4c
  jmp alltraps
80105e17:	e9 27 f8 ff ff       	jmp    80105643 <alltraps>
...
80105e1e:	6a 4d                	push   $0x4d
  jmp alltraps
80105e20:	e9 1e f8 ff ff       	jmp    80105643 <alltraps>
...
80105e27:	6a 4e                	push   $0x4e
  jmp alltraps
80105e29:	e9 15 f8 ff ff       	jmp    80105643 <alltraps>
...
80105e30:	6a 4f                	push   $0x4f
  jmp alltraps
80105e32:	e9 0c f8 ff ff       	jmp    80105643 <alltraps>
...
80105e39:	6a 50                	push   $0x50
  jmp alltraps
80105e3b:	e9 03 f8 ff ff       	jmp    80105643 <alltraps>
...
80105e42:	6a 51                	push   $0x51
  jmp alltraps
80105e44:	e9 fa f7 ff ff       	jmp    80105643 <alltraps>
...
80105e4b:	6a 52                	push   $0x52
  jmp alltraps
80105e4d:	e9 f1 f7 ff ff       	jmp    80105643 <alltraps>
...
80105e54:	6a 53                	push   $0x53
  jmp alltraps
80105e56:	e9 e8 f7 ff ff       	jmp    80105643 <alltraps>
...
80105e5d:	6a 54                	push   $0x54
  jmp alltraps
80105e5f:	e9 df f7 ff ff       	jmp    80105643 <alltraps>
...
80105e66:	6a 55                	push   $0x55
  jmp alltraps
80105e68:	e9 d6 f7 ff ff       	jmp    80105643 <alltraps>
...
80105e6f:	6a 56                	push   $0x56
  jmp alltraps
80105e71:	e9 cd f7 ff ff       	jmp    80105643 <alltraps>
...
80105e78:	6a 57                	push   $0x57
  jmp alltraps
80105e7a:	e9 c4 f7 ff ff       	jmp    80105643 <alltraps>
...
80105e81:	6a 58                	push   $0x58
  jmp alltraps
80105e83:	e9 bb f7 ff ff       	jmp    80105643 <alltraps>
...
80105e8a:	6a 59                	push   $0x59
  jmp alltraps
80105e8c:	e9 b2 f7 ff ff       	jmp    80105643 <alltraps>
...
80105e93:	6a 5a                	push   $0x5a
  jmp alltraps
80105e95:	e9 a9 f7 ff ff       	jmp    80105643 <alltraps>
...
80105e9c:	6a 5b                	push   $0x5b
  jmp alltraps
80105e9e:	e9 a0 f7 ff ff       	jmp    80105643 <alltraps>
...
80105ea5:	6a 5c                	push   $0x5c
  jmp alltraps
80105ea7:	e9 97 f7 ff ff       	jmp    80105643 <alltraps>
...
80105eae:	6a 5d                	push   $0x5d
  jmp alltraps
80105eb0:	e9 8e f7 ff ff       	jmp    80105643 <alltraps>
...
80105eb7:	6a 5e                	push   $0x5e
  jmp alltraps
80105eb9:	e9 85 f7 ff ff       	jmp    80105643 <alltraps>
...
80105ec0:	6a 5f                	push   $0x5f
  jmp alltraps
80105ec2:	e9 7c f7 ff ff       	jmp    80105643 <alltraps>
...
80105ec9:	6a 60                	push   $0x60
  jmp alltraps
80105ecb:	e9 73 f7 ff ff       	jmp    80105643 <alltraps>
...
80105ed2:	6a 61                	push   $0x61
  jmp alltraps
80105ed4:	e9 6a f7 ff ff       	jmp    80105643 <alltraps>
...
80105edb:	6a 62                	push   $0x62
  jmp alltraps
80105edd:	e9 61 f7 ff ff       	jmp    80105643 <alltraps>
...
80105ee4:	6a 63                	push   $0x63
  jmp alltraps
80105ee6:	e9 58 f7 ff ff       	jmp    80105643 <alltraps>
...
80105eed:	6a 64                	push   $0x64
  jmp alltraps
80105eef:	e9 4f f7 ff ff       	jmp    80105643 <alltraps>
...
80105ef6:	6a 65                	push   $0x65
  jmp alltraps
80105ef8:	e9 46 f7 ff ff       	jmp    80105643 <alltraps>
...
80105eff:	6a 66                	push   $0x66
  jmp alltraps
80105f01:	e9 3d f7 ff ff       	jmp    80105643 <alltraps>
...
80105f08:	6a 67                	push   $0x67
  jmp alltraps
80105f0a:	e9 34 f7 ff ff       	jmp    80105643 <alltraps>
...
80105f11:	6a 68                	push   $0x68
  jmp alltraps
80105f13:	e9 2b f7 ff ff       	jmp    80105643 <alltraps>
...
80105f1a:	6a 69                	push   $0x69
  jmp alltraps
80105f1c:	e9 22 f7 ff ff       	jmp    80105643 <alltraps>
...
80105f23:	6a 6a                	push   $0x6a
  jmp alltraps
80105f25:	e9 19 f7 ff ff       	jmp    80105643 <alltraps>
...
80105f2c:	6a 6b                	push   $0x6b
  jmp alltraps
80105f2e:	e9 10 f7 ff ff       	jmp    80105643 <alltraps>
...
80105f35:	6a 6c                	push   $0x6c
  jmp alltraps
80105f37:	e9 07 f7 ff ff       	jmp    80105643 <alltraps>
...
80105f3e:	6a 6d                	push   $0x6d
  jmp alltraps
80105f40:	e9 fe f6 ff ff       	jmp    80105643 <alltraps>
...
80105f47:	6a 6e                	push   $0x6e
  jmp alltraps
80105f49:	e9 f5 f6 ff ff       	jmp    80105643 <alltraps>
...
80105f50:	6a 6f                	push   $0x6f
  jmp alltraps
80105f52:	e9 ec f6 ff ff       	jmp    80105643 <alltraps>
...
80105f59:	6a 70                	push   $0x70
  jmp alltraps
80105f5b:	e9 e3 f6 ff ff       	jmp    80105643 <alltraps>
...
80105f62:	6a 71                	push   $0x71
  jmp alltraps
80105f64:	e9 da f6 ff ff       	jmp    80105643 <alltraps>
...
80105f6b:	6a 72                	push   $0x72
  jmp alltraps
80105f6d:	e9 d1 f6 ff ff       	jmp    80105643 <alltraps>
...
80105f74:	6a 73                	push   $0x73
  jmp alltraps
80105f76:	e9 c8 f6 ff ff       	jmp    80105643 <alltraps>
...
80105f7d:	6a 74                	push   $0x74
  jmp alltraps
80105f7f:	e9 bf f6 ff ff       	jmp    80105643 <alltraps>
...
80105f86:	6a 75                	push   $0x75
  jmp alltraps
80105f88:	e9 b6 f6 ff ff       	jmp    80105643 <alltraps>
...
80105f8f:	6a 76                	push   $0x76
  jmp alltraps
80105f91:	e9 ad f6 ff ff       	jmp    80105643 <alltraps>
...
80105f98:	6a 77                	push   $0x77
  jmp alltraps
80105f9a:	e9 a4 f6 ff ff       	jmp    80105643 <alltraps>
...
80105fa1:	6a 78                	push   $0x78
  jmp alltraps
80105fa3:	e9 9b f6 ff ff       	jmp    80105643 <alltraps>
...
80105faa:	6a 79                	push   $0x79
  jmp alltraps
80105fac:	e9 92 f6 ff ff       	jmp    80105643 <alltraps>
...
80105fb3:	6a 7a                	push   $0x7a
  jmp alltraps
80105fb5:	e9 89 f6 ff ff       	jmp    80105643 <alltraps>
...
80105fbc:	6a 7b                	push   $0x7b
  jmp alltraps
80105fbe:	e9 80 f6 ff ff       	jmp    80105643 <alltraps>
...
80105fc5:	6a 7c                	push   $0x7c
  jmp alltraps
80105fc7:	e9 77 f6 ff ff       	jmp    80105643 <alltraps>
...
80105fce:	6a 7d                	push   $0x7d
  jmp alltraps
80105fd0:	e9 6e f6 ff ff       	jmp    80105643 <alltraps>
...
80105fd7:	6a 7e                	push   $0x7e
  jmp alltraps
80105fd9:	e9 65 f6 ff ff       	jmp    80105643 <alltraps>
...
80105fe0:	6a 7f                	push   $0x7f
  jmp alltraps
80105fe2:	e9 5c f6 ff ff       	jmp    80105643 <alltraps>
...
80105fe9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105fee:	e9 50 f6 ff ff       	jmp    80105643 <alltraps>
...
80105ff5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105ffa:	e9 44 f6 ff ff       	jmp    80105643 <alltraps>
...
80106001:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106006:	e9 38 f6 ff ff       	jmp    80105643 <alltraps>
...
8010600d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106012:	e9 2c f6 ff ff       	jmp    80105643 <alltraps>
...
80106019:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010601e:	e9 20 f6 ff ff       	jmp    80105643 <alltraps>
...
80106025:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010602a:	e9 14 f6 ff ff       	jmp    80105643 <alltraps>
...
80106031:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106036:	e9 08 f6 ff ff       	jmp    80105643 <alltraps>
...
8010603d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106042:	e9 fc f5 ff ff       	jmp    80105643 <alltraps>
...
80106049:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010604e:	e9 f0 f5 ff ff       	jmp    80105643 <alltraps>
...
80106055:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010605a:	e9 e4 f5 ff ff       	jmp    80105643 <alltraps>
...
80106061:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106066:	e9 d8 f5 ff ff       	jmp    80105643 <alltraps>
...
8010606d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106072:	e9 cc f5 ff ff       	jmp    80105643 <alltraps>
...
80106079:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010607e:	e9 c0 f5 ff ff       	jmp    80105643 <alltraps>
...
80106085:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010608a:	e9 b4 f5 ff ff       	jmp    80105643 <alltraps>
...
80106091:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106096:	e9 a8 f5 ff ff       	jmp    80105643 <alltraps>
...
8010609d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801060a2:	e9 9c f5 ff ff       	jmp    80105643 <alltraps>
...
801060a9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801060ae:	e9 90 f5 ff ff       	jmp    80105643 <alltraps>
...
801060b5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801060ba:	e9 84 f5 ff ff       	jmp    80105643 <alltraps>
...
801060c1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801060c6:	e9 78 f5 ff ff       	jmp    80105643 <alltraps>
...
801060cd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801060d2:	e9 6c f5 ff ff       	jmp    80105643 <alltraps>
...
801060d9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801060de:	e9 60 f5 ff ff       	jmp    80105643 <alltraps>
...
801060e5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801060ea:	e9 54 f5 ff ff       	jmp    80105643 <alltraps>
...
801060f1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801060f6:	e9 48 f5 ff ff       	jmp    80105643 <alltraps>
...
801060fd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106102:	e9 3c f5 ff ff       	jmp    80105643 <alltraps>
...
80106109:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010610e:	e9 30 f5 ff ff       	jmp    80105643 <alltraps>
...
80106115:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010611a:	e9 24 f5 ff ff       	jmp    80105643 <alltraps>
...
80106121:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106126:	e9 18 f5 ff ff       	jmp    80105643 <alltraps>
...
8010612d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106132:	e9 0c f5 ff ff       	jmp    80105643 <alltraps>
...
80106139:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010613e:	e9 00 f5 ff ff       	jmp    80105643 <alltraps>
...
80106145:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010614a:	e9 f4 f4 ff ff       	jmp    80105643 <alltraps>
...
80106151:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106156:	e9 e8 f4 ff ff       	jmp    80105643 <alltraps>
...
8010615d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106162:	e9 dc f4 ff ff       	jmp    80105643 <alltraps>
...
80106169:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010616e:	e9 d0 f4 ff ff       	jmp    80105643 <alltraps>
...
80106175:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010617a:	e9 c4 f4 ff ff       	jmp    80105643 <alltraps>
...
80106181:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106186:	e9 b8 f4 ff ff       	jmp    80105643 <alltraps>
...
8010618d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106192:	e9 ac f4 ff ff       	jmp    80105643 <alltraps>
...
80106199:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010619e:	e9 a0 f4 ff ff       	jmp    80105643 <alltraps>
...
801061a5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801061aa:	e9 94 f4 ff ff       	jmp    80105643 <alltraps>
...
801061b1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801061b6:	e9 88 f4 ff ff       	jmp    80105643 <alltraps>
...
801061bd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801061c2:	e9 7c f4 ff ff       	jmp    80105643 <alltraps>
...
801061c9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801061ce:	e9 70 f4 ff ff       	jmp    80105643 <alltraps>
...
801061d5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801061da:	e9 64 f4 ff ff       	jmp    80105643 <alltraps>
...
801061e1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801061e6:	e9 58 f4 ff ff       	jmp    80105643 <alltraps>
...
801061ed:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801061f2:	e9 4c f4 ff ff       	jmp    80105643 <alltraps>
...
801061f9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801061fe:	e9 40 f4 ff ff       	jmp    80105643 <alltraps>
...
80106205:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010620a:	e9 34 f4 ff ff       	jmp    80105643 <alltraps>
...
80106211:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106216:	e9 28 f4 ff ff       	jmp    80105643 <alltraps>
...
8010621d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106222:	e9 1c f4 ff ff       	jmp    80105643 <alltraps>
...
80106229:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010622e:	e9 10 f4 ff ff       	jmp    80105643 <alltraps>
...
80106235:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010623a:	e9 04 f4 ff ff       	jmp    80105643 <alltraps>
...
80106241:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106246:	e9 f8 f3 ff ff       	jmp    80105643 <alltraps>
...
8010624d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106252:	e9 ec f3 ff ff       	jmp    80105643 <alltraps>
...
80106259:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010625e:	e9 e0 f3 ff ff       	jmp    80105643 <alltraps>
...
80106265:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010626a:	e9 d4 f3 ff ff       	jmp    80105643 <alltraps>
...
80106271:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106276:	e9 c8 f3 ff ff       	jmp    80105643 <alltraps>
...
8010627d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106282:	e9 bc f3 ff ff       	jmp    80105643 <alltraps>
...
80106289:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010628e:	e9 b0 f3 ff ff       	jmp    80105643 <alltraps>
...
80106295:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010629a:	e9 a4 f3 ff ff       	jmp    80105643 <alltraps>
...
801062a1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801062a6:	e9 98 f3 ff ff       	jmp    80105643 <alltraps>
...
801062ad:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801062b2:	e9 8c f3 ff ff       	jmp    80105643 <alltraps>
...
801062b9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801062be:	e9 80 f3 ff ff       	jmp    80105643 <alltraps>
...
801062c5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801062ca:	e9 74 f3 ff ff       	jmp    80105643 <alltraps>
...
801062d1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801062d6:	e9 68 f3 ff ff       	jmp    80105643 <alltraps>
...
801062dd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801062e2:	e9 5c f3 ff ff       	jmp    80105643 <alltraps>
...
801062e9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801062ee:	e9 50 f3 ff ff       	jmp    80105643 <alltraps>
...
801062f5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801062fa:	e9 44 f3 ff ff       	jmp    80105643 <alltraps>
...
80106301:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106306:	e9 38 f3 ff ff       	jmp    80105643 <alltraps>
...
8010630d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106312:	e9 2c f3 ff ff       	jmp    80105643 <alltraps>
...
80106319:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010631e:	e9 20 f3 ff ff       	jmp    80105643 <alltraps>
...
80106325:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010632a:	e9 14 f3 ff ff       	jmp    80105643 <alltraps>
...
80106331:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106336:	e9 08 f3 ff ff       	jmp    80105643 <alltraps>
...
8010633d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106342:	e9 fc f2 ff ff       	jmp    80105643 <alltraps>
...
80106349:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010634e:	e9 f0 f2 ff ff       	jmp    80105643 <alltraps>
...
80106355:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010635a:	e9 e4 f2 ff ff       	jmp    80105643 <alltraps>
...
80106361:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106366:	e9 d8 f2 ff ff       	jmp    80105643 <alltraps>
...
8010636d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106372:	e9 cc f2 ff ff       	jmp    80105643 <alltraps>
...
80106379:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010637e:	e9 c0 f2 ff ff       	jmp    80105643 <alltraps>
...
80106385:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010638a:	e9 b4 f2 ff ff       	jmp    80105643 <alltraps>
...
80106391:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106396:	e9 a8 f2 ff ff       	jmp    80105643 <alltraps>
...
8010639d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801063a2:	e9 9c f2 ff ff       	jmp    80105643 <alltraps>
...
801063a9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801063ae:	e9 90 f2 ff ff       	jmp    80105643 <alltraps>
...
801063b5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801063ba:	e9 84 f2 ff ff       	jmp    80105643 <alltraps>
...
801063c1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801063c6:	e9 78 f2 ff ff       	jmp    80105643 <alltraps>
...
801063cd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801063d2:	e9 6c f2 ff ff       	jmp    80105643 <alltraps>
...
801063d9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801063de:	e9 60 f2 ff ff       	jmp    80105643 <alltraps>
...
801063e5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801063ea:	e9 54 f2 ff ff       	jmp    80105643 <alltraps>
...
801063f1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801063f6:	e9 48 f2 ff ff       	jmp    80105643 <alltraps>
...
801063fd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106402:	e9 3c f2 ff ff       	jmp    80105643 <alltraps>
...
80106409:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010640e:	e9 30 f2 ff ff       	jmp    80105643 <alltraps>
...
80106415:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010641a:	e9 24 f2 ff ff       	jmp    80105643 <alltraps>
...
80106421:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106426:	e9 18 f2 ff ff       	jmp    80105643 <alltraps>
...
8010642d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106432:	e9 0c f2 ff ff       	jmp    80105643 <alltraps>
...
80106439:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010643e:	e9 00 f2 ff ff       	jmp    80105643 <alltraps>
...
80106445:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010644a:	e9 f4 f1 ff ff       	jmp    80105643 <alltraps>
...
80106451:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106456:	e9 e8 f1 ff ff       	jmp    80105643 <alltraps>
...
8010645d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106462:	e9 dc f1 ff ff       	jmp    80105643 <alltraps>
...
80106469:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010646e:	e9 d0 f1 ff ff       	jmp    80105643 <alltraps>
...
80106475:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010647a:	e9 c4 f1 ff ff       	jmp    80105643 <alltraps>
...
80106481:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106486:	e9 b8 f1 ff ff       	jmp    80105643 <alltraps>
...
8010648d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106492:	e9 ac f1 ff ff       	jmp    80105643 <alltraps>
...
80106499:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010649e:	e9 a0 f1 ff ff       	jmp    80105643 <alltraps>
...
801064a5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801064aa:	e9 94 f1 ff ff       	jmp    80105643 <alltraps>
...
801064b1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801064b6:	e9 88 f1 ff ff       	jmp    80105643 <alltraps>
...
801064bd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801064c2:	e9 7c f1 ff ff       	jmp    80105643 <alltraps>
...
801064c9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801064ce:	e9 70 f1 ff ff       	jmp    80105643 <alltraps>
...
801064d5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801064da:	e9 64 f1 ff ff       	jmp    80105643 <alltraps>
...
801064e1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801064e6:	e9 58 f1 ff ff       	jmp    80105643 <alltraps>
...
801064ed:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801064f2:	e9 4c f1 ff ff       	jmp    80105643 <alltraps>
...
801064f9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801064fe:	e9 40 f1 ff ff       	jmp    80105643 <alltraps>
...
80106505:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010650a:	e9 34 f1 ff ff       	jmp    80105643 <alltraps>
...
80106511:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106516:	e9 28 f1 ff ff       	jmp    80105643 <alltraps>
...
8010651d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106522:	e9 1c f1 ff ff       	jmp    80105643 <alltraps>
...
80106529:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010652e:	e9 10 f1 ff ff       	jmp    80105643 <alltraps>
...
80106535:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010653a:	e9 04 f1 ff ff       	jmp    80105643 <alltraps>
...
80106541:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106546:	e9 f8 f0 ff ff       	jmp    80105643 <alltraps>
...
8010654d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106552:	e9 ec f0 ff ff       	jmp    80105643 <alltraps>
...
80106559:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010655e:	e9 e0 f0 ff ff       	jmp    80105643 <alltraps>
...
80106565:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010656a:	e9 d4 f0 ff ff       	jmp    80105643 <alltraps>
...
80106571:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106576:	e9 c8 f0 ff ff       	jmp    80105643 <alltraps>
...
8010657d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106582:	e9 bc f0 ff ff       	jmp    80105643 <alltraps>
...
80106589:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010658e:	e9 b0 f0 ff ff       	jmp    80105643 <alltraps>
...
80106595:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010659a:	e9 a4 f0 ff ff       	jmp    80105643 <alltraps>
...
801065a1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801065a6:	e9 98 f0 ff ff       	jmp    80105643 <alltraps>
...
801065ad:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801065b2:	e9 8c f0 ff ff       	jmp    80105643 <alltraps>
...
801065b9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801065be:	e9 80 f0 ff ff       	jmp    80105643 <alltraps>
...
801065c5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801065ca:	e9 74 f0 ff ff       	jmp    80105643 <alltraps>
...
801065d1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801065d6:	e9 68 f0 ff ff       	jmp    80105643 <alltraps>
...
801065dd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801065e2:	e9 5c f0 ff ff       	jmp    80105643 <alltraps>
...
80106634:	e8 87 be ff ff       	call   801024c0 <kalloc>
...
80106744:	e8 c7 bb ff ff       	call   80102310 <kfree>
      *pte = 0;
...
801067a3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801067a6:	e8 15 d0 ff ff       	call   801037c0 <cpuid>
...
80106874:	0f 84 c2 00 00 00    	je     8010693c <switchuvm+0xec>
  pushcli();
8010687a:	e8 f1 d9 ff ff       	call   80104270 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010687f:	e8 bc ce ff ff       	call   80103740 <mycpu>
80106884:	89 c6                	mov    %eax,%esi
80106886:	e8 b5 ce ff ff       	call   80103740 <mycpu>
...
80106898:	e8 a3 ce ff ff       	call   80103740 <mycpu>
...
801068e1:	e8 5a ce ff ff       	call   80103740 <mycpu>
...
801068f9:	e8 42 ce ff ff       	call   80103740 <mycpu>
801068fe:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106904:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106907:	e8 34 ce ff ff       	call   80103740 <mycpu>
...
80106929:	5d                   	pop    %ebp
  popcli();
8010692a:	e9 81 d9 ff ff       	jmp    801042b0 <popcli>
...
8010697b:	77 49                	ja     801069c6 <inituvm+0x66>
  mem = kalloc();
8010697d:	e8 3e bb ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
8010698f:	e8 bc da ff ff       	call   80104450 <memset>
...
801069c0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801069c1:	e9 3a db ff ff       	jmp    80104500 <memmove>
    panic("inituvm: more than a page");
801069c6:	83 ec 0c             	sub    $0xc,%esp
801069c9:	68 b1 78 10 80       	push   $0x801078b1
...
80106a51:	e8 0a af ff ff       	call   80101960 <readi>
...
80106aeb:	e8 60 d9 ff ff       	call   80104450 <memset>
...
80106b19:	0f 86 81 00 00 00    	jbe    80106ba0 <allocuvm+0x100>
    mem = kalloc();
80106b1f:	e8 9c b9 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
...
80106b2d:	68 e9 78 10 80       	push   $0x801078e9
...
80106b63:	68 01 79 10 80       	push   $0x80107901
...
80106b8b:	e8 80 b7 ff ff       	call   80102310 <kfree>
      return 0;
...
80106c4e:	e8 bd b6 ff ff       	call   80102310 <kfree>
...
80106c63:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106c64:	e9 a7 b6 ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
...
80106c85:	e8 36 b8 ff ff       	call   801024c0 <kalloc>
...
80106ca0:	e8 ab d7 ff ff       	call   80104450 <memset>
...
80106d90:	e8 6b d7 ff ff       	call   80104500 <memmove>
...
80106de5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106de8:	e8 d3 b6 ff ff       	call   801024c0 <kalloc>
...
80106e1c:	e8 ef b4 ff ff       	call   80102310 <kfree>
      goto bad;
...
80106f23:	83 ec 10             	sub    $0x10,%esp
	cprintf("%s\n", str);
80106f26:	ff 75 08             	pushl  0x8(%ebp)
80106f29:	68 90 79 10 80       	push   $0x80107990
80106f2e:	e8 2d 97 ff ff       	call   80100660 <cprintf>
 	return 0xABCDABCD;
}
80106f33:	b8 cd ab cd ab       	mov    $0xabcdabcd,%eax
80106f38:	c9                   	leave  
80106f39:	c3                   	ret    
80106f3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80106f40 <sys_myfunction>:

// Wrapper for my_syscall
int sys_myfunction(void) {
80106f40:	55                   	push   %ebp
80106f41:	89 e5                	mov    %esp,%ebp
80106f43:	83 ec 20             	sub    $0x20,%esp
	char *str;
	// Decode argument using argstr(function)
	if (argstr(0, &str) < 0)
80106f46:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106f49:	50                   	push   %eax
80106f4a:	6a 00                	push   $0x0
80106f4c:	e8 af d8 ff ff       	call   80104800 <argstr>
80106f51:	83 c4 10             	add    $0x10,%esp
80106f54:	85 c0                	test   %eax,%eax
80106f56:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106f5b:	78 18                	js     80106f75 <sys_myfunction+0x35>
	cprintf("%s\n", str);
80106f5d:	83 ec 08             	sub    $0x8,%esp
80106f60:	ff 75 f4             	pushl  -0xc(%ebp)
80106f63:	68 90 79 10 80       	push   $0x80107990
80106f68:	e8 f3 96 ff ff       	call   80100660 <cprintf>
		return -1;
	return myfunction(str);
80106f6d:	83 c4 10             	add    $0x10,%esp
80106f70:	ba cd ab cd ab       	mov    $0xabcdabcd,%edx
}
80106f75:	89 d0                	mov    %edx,%eax
80106f77:	c9                   	leave  
80106f78:	c3                   	ret    
